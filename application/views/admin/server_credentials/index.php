                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-slate-700/30 transition-colors">
                        ...
                        <td class="p-4 text-center align-top">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <a href="<?= base_url('admin/server_credentials/delete/'.$row['id']) ?>" data-confirm="Apakah Anda yakin ingin menghapus data ini?" class="p-1.5 text-red-600 hover:bg-red-50 dark:hover:bg-red-500/20 rounded transition-colors" title="Hapus">
